...
class StakeholderAnalysisResultSerializer(serializers.Serializer):
    ...
    iso_clause = serializers.CharField()
    execution_time = serializers.FloatField()
    stakeholders_analyzed = serializers.IntegerField()
    critical_stakeholders = serializers.ListField(child=serializers.DictField())
    changes_detected = serializers.ListField(child=serializers.DictField())
    network_statistics = serializers.DictField()
    influence_metrics = serializers.DictField()
    network_visualization = NetworkVisualizationSerializer()
