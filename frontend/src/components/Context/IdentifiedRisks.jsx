    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-slate-900/50 p-6 transition-colors">
      ...
      {!riesgos || riesgos.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-slate-500 dark:text-slate-400">No se identificaron riesgos críticos</p>
        </div>
      ) : (
              ...
              {riesgo.mitigacion && (
                <div className="ml-7 mt-3 pt-3 border-t dark:border-slate-700">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">Plan de Mitigación:</p>
