...
const UserMenu = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {/* Menú desplegable */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-slate-800/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl overflow-hidden z-50">
          {/* Header del menú */}
            ...
            <div className="p-2 border-b border-slate-700/50">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-white">{currentOrganization?.name}</span>
                </div>
                <svg
                  className={`w-4 h-4 text-slate-400 transition-transform ${showOrgSelector ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {showOrgSelector && (
                <div className="mt-1 space-y-1">
                  {organizations.map((org) => (
                    ...
                    >
                      <span>{org.name}</span>
                      <span className="text-xs text-slate-500">{org.role_display}</span>
                    </button>
                  ))}
                </div>
              )}
          ...
          <div className="p-2">
            ...
            >
              ...
              <span>{t('literals.Configuración')}</span>
            </a>
            ...
            >
              ...
              <span>{t('literals.Mi Perfil')}</span>
            </a>
            ...
            >
              ...
              <span>{t('literals.Cerrar Sesión')}</span>
            </button>
          </div>
        </div>
      )}
