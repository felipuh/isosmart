      ...
      <div className="space-y-4">
        {objectives.map((obj, index) => {
          ...
          return (
            <div 
              key={index} 
              className="p-4 bg-gradient-to-br from-gray-50 to-white rounded-lg border-2 border-gray-200 hover:border-blue-400 transition-all"
            >
              <div className="flex items-start justify-between mb-3">
                <h3 className="font-bold text-gray-900 flex-1">{obj.indicator_name}</h3>
