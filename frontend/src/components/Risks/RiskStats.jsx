  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={source} className="bg-gray-50 rounded-lg p-4 text-center">
                ...
                <div className="text-xl font-bold text-gray-900">{stats.by_source?.[source] || 0}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex justify-end">
        <button onClick={onRefresh} className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
