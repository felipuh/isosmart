  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6">
        <h2 className="text-xl font-bold text-white mb-4">{editingId ? 'Editar' : 'Nueva'} Infraestructura</h2>
      ...
      <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-lg overflow-hidden">
        ...
        {items.length === 0 && <div className="text-center py-8 text-gray-400">No hay infraestructura</div>}
      </div>
    </div>
  );
};
